      ...
      */}
      ...
      <div className="flex flex-1 flex-col p-4 md:p-5">
        ...
        */}
        ...
        {/*
          ⚠️ 차량 특징 태그 pill 3개("1톤 / 초장축 / 즉시 출고")는 2026-07-31 제거했다.
             클라이언트 요청. 카드 한 장에 분류 뱃지 + 모델 + 트림 + 한 줄 설명까지
             이미 4단이라, 그 아래 pill 3개가 더 붙으면 정보가 과했다.
             데이터의 `tags` 필드도 함께 지웠으므로 되살리려면 vehicles.ts 부터 손대야 한다.
        */}
        ...
        */}
        {/*
          ⚠️ "차량 자세히 보기" 보조 버튼은 2026-07-31 제거했다.
             연결할 상세 화면이 없어 눌러도 아무 일이 일어나지 않는 버튼이었다.
             동작 없는 버튼은 없는 것만 못하므로, 상세 화면이 정해지면 그때 다시 넣는다.
        */}
        <div className="mt-auto pt-4 md:pt-5">
          <button
            ...
            className="block w-full cursor-pointer rounded-xl bg-primary px-3 py-3.5 text-center text-sm font-bold text-white transition-colors duration-200 hover:bg-primary-hover md:text-base"
          >
            이 차량으로 상담받기
          </button>
        </div>
