                ...
                >
                  ...
                  >
                    {/*
                      ...
                      기존 그림자는 초록(rgba(3,199,90,...)) 하드코딩이었다.
                      구글폼 13번에 맞춰 `shadow-primary/25` 로 바꿔
                      배지 아래 번지는 색까지 블루 토큰을 따라가게 했다.
                    */}
                    <span
                      aria-hidden="true"
                      className="bg-primary shadow-primary/25 flex h-12 w-12 shrink-0 items-center justify-center rounded-full text-lg font-extrabold text-white shadow-md transition-transform duration-300 group-hover:scale-110"
                    >
                      {/* 1 → "01" 형태로 0 을 채워 표시 */}
